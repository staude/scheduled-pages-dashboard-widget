=== Scheduled Pages Dashboad Widget ===
Contributors: f.staude
Donate link: http://www.staude.net/donate
Tags: widgets, dashboard, pages, schedule
...
The dashboard widget shows the schedued pages
...
The widget shows the scheduled pages.
...
Dieses Plugin stellt ein Widget für das Dashbord bereit, das die Seiten anzeigt, die in der Zukunft automatisch veröffentlicht werden.
...
1. Install the plugin from within the Dashboard or upload the directory `scheduled-pages-dashboard-widget` and all its contents to the `/wp-content/plugins/` directory
...
Select the project "WP Plugin: Scheduled Pages Dashboad Widget" and report it.
...
Wähle das Projekt "WP Plugin: Scheduled Pages Dashboad Widget" und melde den Fehler.
Ich möchte eine neue Funktion vorschlage

= Bitte geh auf die Seite http://bugs.staude.net und melde dich dort an. =

Wähle das Projekt "WP Plugin: Scheduled Pages Dashboad Widget" und trag deinen Wunsch ein.
